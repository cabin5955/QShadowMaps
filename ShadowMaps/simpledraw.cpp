...
SimpleDraw::~SimpleDraw()
{
    ...
    glDeleteVertexArrays(1, &debugQuadVBO);
    glDeleteBuffers(1, &debugQuadVAO);
}

void SimpleDraw::renderPlane(const Shader &shader, glm::mat4 model)
{
...
void SimpleDraw::renderCube(const Shader &shader, glm::mat4 model)
{
    shader.setMat4("model", model);
    // initialize (if necessary)
    if (cubeVAO == 0)
...
void SimpleDraw::renderDebug(int screenWidth,int screenHeight, unsigned int texID)
{
